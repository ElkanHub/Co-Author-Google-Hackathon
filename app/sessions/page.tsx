    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black font-sans text-zinc-900 dark:text-zinc-100 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <header className="flex items-center justify-between">
          <div>
            <Link href="/">
            <h1 className="text-2xl font-serif font-bold tracking-tight">Co-Author</h1>
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-zinc-900 dark:bg-white text-zinc-50 dark:text-zinc-900 px-4 py-2 rounded-none font-medium hover:opacity-90 transition-opacity"
            >
              <Plus className="w-4 h-4" />
              <span className="font-serif font-bold">New Session</span>
            </button>
          </div>
        </header>
            ...
            <div className="flex flex-col gap-2">
              {documents.map(doc => (
                <Link
                  key={doc.id}
                  href={`/editor/${doc.id}`}
                  className="group flex items-center justify-between p-4 rounded-none border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all shadow-sm hover:shadow-md relative"
                >
